        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative w-full max-w-2xl bg-card border-t sm:border border-border sm:rounded-xl overflow-hidden shadow-2xl max-h-[90vh] sm:max-h-[85vh]"
                ...
                >
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.15 }}
                        className="overflow-y-auto max-h-[calc(90vh-140px)] sm:max-h-[calc(85vh-140px)]"
                    >
                        {/* Product Image */}
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <div className="text-sm text-muted-foreground">
                                                    +{(DELIVERY_FEE_PERCENTAGE * 100).toFixed(0)}% delivery fee
                                                </div>
                                            </div>
                                        </div>
                                        <motion.div
